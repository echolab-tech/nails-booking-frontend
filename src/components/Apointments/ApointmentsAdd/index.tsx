            ...
            <Form>
              ...
              <div className="rounded-lg border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <div className="flex justify-center px-6.5 py-4">
                  <button
                    type="button"
                    className="text-gray-900 border-gray-300 hover:bg-gray-100 focus:ring-gray-100 dark:bg-gray-800 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700 mb-2 me-2 rounded-full border bg-white px-5 py-2.5 text-sm font-medium focus:outline-none focus:ring-4 dark:text-white"
                ...
                <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                  ...
                  <div className="flex w-full justify-center xl:w-1/2">
                    <Link href="/apointments/add-assistant" passHref>
                      <button
                        type="button"
                        className="w-full justify-center rounded bg-green-600 p-3 font-medium text-gray hover:bg-opacity-90 sm:w-auto"
                      >
                        Next
                      </button>
                    </Link>
