...
const ApointmentAdd = () => {
    ...
    >([]);
    useEffect(() => {
    // Làm việc giả lập: danh sách các cuộc hẹn
    ...
    // Cập nhật state với danh sách cuộc hẹn giả lập
            ...
            <form>
              ...
              <div className="rounded-lg border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                  <div className="border-gray-300 hover:border-gray-500 flex w-full rounded-md border focus:border-blue-500 focus:ring focus:ring-blue-200 xl:w-1/2">
                    <div className="flex flex-1 px-6.5 py-4">
                      <div className="w-full xl:w-3/4">
                        <label className="mb-3 ml-3 block text-sm font-medium text-black dark:text-white">
                          Apointment
                        </label>
                        <span className="ml-3">2024/05/21 11:45</span>
                        <div className="flex">
                          <span className="ml-3">11:45</span>
                          <span className="ml-3">45min -</span>
                          <span className="ml-3">huynh thanh huynh</span>
                        </div>
                      </div>
                      <div className="flex w-full items-center justify-end xl:w-1/4">
                        <label className="mb-3 ml-3 block text-sm font-medium text-black dark:text-white">
                          $10.00
                        </label>
                      </div>
                  ...
                  <div className="border-gray-300 hover:border-gray-500 w-full rounded-md border focus:border-blue-500 focus:ring focus:ring-blue-200 xl:w-1/2">
                    <div className="flex flex-1 px-6.5 py-4">
                      <div className="w-full xl:w-3/4">
                        <label className="mb-3 ml-3 block text-sm font-medium text-black dark:text-white">
                          Apointment
                ...
                <div className="flex gap-6 overflow-x-auto px-6.5 py-4">
                  {/* <div className="mb-4.5 flex gap-6  overflow-x-auto xl:max-w-[1500px]"> */}
                        ...
                        <div className="w-full">
                          ...
                          <div className="ml-3">
                            ...
                            <div className="flex">
                              ...
                              <span className="ml-3">{appointment.client}</span>
                            </div>
                          </div>
                        </div>
