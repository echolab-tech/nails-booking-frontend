        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/assistants" || pathname.includes("assistants")
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <li>
                <Link
                  href="/services/list"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("services/list") &&
                    "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <GoArchive />
              ...
              {/* <!-- Menu Item service summary --> */}

              <SidebarLinkGroup
                activeCondition={
                  pathname === "/service-summary" || pathname.includes("category")
                }
              >
                {(handleClick, open) => {
                  return (
                      ...
                      <Link
                        ...
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === "/service-summary" ||
                            pathname.includes("service-summary")) &&
                          "bg-graydark dark:bg-meta-4"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
