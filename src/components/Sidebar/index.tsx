  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <Link href="/">
          <h2 className="text-3xl text-white">Luxury Nails Inc</h2>
          {/* <Image
            width={176}
            height={32}
        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/service/form-new"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/service/form-new" && "text-white"
                              }`}
                            >
                              Service New
                            </Link>
                          ...
                          <li>
                            <Link
                              href="/service/combo-new"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/service/combo-new" &&
                                "text-white"
                              }`}
                            >
                              Service combo New
                          ...
                          <li>
                            <Link
                              href="/service/list"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/service/list" && "text-white"
                              } `}
                            >
                              Service List
                            </Link>
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/category/new"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/category/new" && "text-white"
                              }`}
                            >
                              Category New
                            </Link>
                          ...
                          <li>
                            <Link
                              href="/category/list"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/category/list" && "text-white"
                              } `}
                            >
                              Category List
                            </Link>
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/customers/add"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/customers/add" && "text-white"
                              }`}
                            >
                              Add new
                            </Link>
              ...
              {/* <!-- Menu Item Apointments --> */}
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/apointments" ||
                  pathname.includes("apointments")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/apointments/add"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/apointments/add" && "text-white"
                              }`}
                            >
                              Add new
                            </Link>
