...
const AssistantCheckboxes: FC<AssistantCheckboxesProps> = ({ assistantData }) => {
  return (
    <FieldArray name="assistantServices">
      {({ push, remove, form: { values } }: { push: (value: any) => void; remove: (index: number) => void; form: FormikValues }) => (
