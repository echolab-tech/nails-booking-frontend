...
interface AdvancedPricingSubServiceDialogProps {
  formik: any;
...
const AdvancedPricingSubServiceDialog: React.FC<
  AdvancedPricingSubServiceDialogProps
> = ({ optionTime, handleSave, assistants, handleClose, open }) => {
  useEffect(() => {}, []);
  ...
  return (
    ...
    >
      ...
      <Modal.Body>
        <FieldArray name={`subServiceAdvancePrices`}>
          {({ push, remove }) => (
            <div
              ...
              {assistants?.map((assistant: Assistant, index: number) => (
                <div key={index} className="flex flex-col gap-6 xl:flex-row">
                  ...
                  <Field
                    type="text"
                    value={assistant?.id}
                    name={`subServiceAdvancePrices[${index}].assistant_id`}
                    className="hidden"
                  />
                  <div className="w-full xl:w-1/4">
                    ...
                    <Field
                      ...
                      name={`subServiceAdvancePrices[${index}].time`}
                    >
                  ...
                  <div className="w-full xl:w-1/4">
                    ...
                    <Field
                      name={`subServiceAdvancePrices[${index}].price`}
                      type="text"
                      placeholder="$0.00"
...
export default AdvancedPricingSubServiceDialog;
